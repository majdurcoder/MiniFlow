...
| API Keys | OpenAI + Smallest AI (required) |
...
Go to **Settings → Integrations** and click **Connect** next to each service. MiniFlow uses OAuth — your credentials are never stored.

Supported: Slack · Gmail · Google Calendar · GitHub · Notion · Linear · Jira · Spotify · Discord
